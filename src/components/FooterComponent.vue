...
<footer class="bg-white md:flex md:items-center md:justify-between shadow rounded-lg p-4 md:p-6 xl:p-8 my-6 mx-4 dark:bg-gray-800 dark:border-gray-700 bottom-0">
    ...
    <p class="text-center text-sm text-gray-500 my-10">
      &copy; 2023 <a href="https://toolbrothers.com/" class="hover:underline" target="_blank">Toolbrothers</a>. All rights reserved.
    </p>
</template>