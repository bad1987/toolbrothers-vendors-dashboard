<script setup>
    ...
    const disableOrUnablePaymentMethod = () => {
    axios
        .get("/payment/update/", payment_method_id.value)
        .then((response) => {
...
<template>
    <!-- drawer component -->
    <div id="drawer-right-example" class="fixed right-0 z-50 h-screen p-4 overflow-y-auto transition-transform translate-x-full bg-white w-80 dark:bg-gray-800" tabindex="-1" aria-labelledby="drawer-right-label">
