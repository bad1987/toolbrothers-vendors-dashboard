...
<template>
     <nav class="fixed z-30 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:border-gray-700">
  ...
  <div class="fixed inset-0 z-10 hidden bg-gray-900/50 dark:bg-gray-900/90 dark:bg-gray-800 dark:border-gray-700" id="sidebarBackdrop"></div>
</template>