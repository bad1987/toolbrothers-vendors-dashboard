    ...
    <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-gray-800">
      ...
      <div class="items-center justify-between lg:flex">
        <div class="items-center justify-between lg:flex">
          <div class="mb-4 lg:mb-0">
            <h3 class="mb-2 text-xl font-bold text-gray-900 dark:text-white">Your payment methods <span
                class="px-2 py-1 text-sm text-white bg-green-500 rounded-md">Active</span></h3>
            <span class="text-base font-normal text-gray-500 dark:text-gray-400">This is a list of all your payment
              method</span>
          </div>
        </div>
            ...
            <div class="overflow-hidden shadow sm:rounded-lg">
              <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                ...
                <tbody class="bg-white dark:bg-gray-800">
                  ...
                  <tr v-for="item in payment_method" :key="item.id">
                    <td :data-modal-target="`staticModal${item.id}`" data-modal-toggle="staticModal{{ item.id }}"
                    ...
                    <td class="p-4 whitespace-nowrap">
                      <span v-if="item.status == 'A'"
                        class="bg-green-100 text-green-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-green-400 border border-green-100 dark:border-green-500">Unable</span>
                      <span v-if="item.status == 'D'"
                        class="bg-green-100 text-red-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded-md dark:bg-gray-700 dark:text-red-400 border border-red-100 dark:border-red-500">Disable</span>
                    </td>
                    <td class="p-4 whitespace-nowrap">
                      <span v-if="item.status == 'A'"
                        class="px-5 py-1 mb-2 mr-2 text-sm font-medium text-center text-red-700 border border-red-700 rounded-lg cursor-pointer hover:text-white hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">Enable</span>
                      <span v-if="item.status == 'D'"
                        class="px-5 py-1 mb-2 mr-2 text-sm font-medium text-center text-blue-700 border border-blue-700 rounded-lg cursor-pointer hover:text-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800">Disable</span>
                    </td>
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
                          ...
                          <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                            <ul
                              ...
                              id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent{{ item.id }}" role="tablist">
                              <li class="">
                                <button id="faq-tab{{ item.id }}" data-tabs-target="#faq{{ item.id }}" type="button"
                                  role="tab" aria-controls="faq{{ item.id }}" aria-selected="true"
                                  class="inline-block w-full p-4 rounded-tl-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">General</button>
                              </li>
                              <li class="">
                                <button id="about-tab{{ item.id }}" data-tabs-target="#about{{ item.id }}" type="button"
                                  role="tab" aria-controls="about{{ item.id }}" aria-selected="false"
                                  class="inline-block w-full p-4 rounded-tr-lg bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Configure</button>
                              </li>
                            </ul>
                            <button type="button"
                          ...
                          <div class="p-4 bg-white rounded-lg shadow-sm sm:p-6 dark:bg-gray-800">
                            <div id="fullWidthTabContent{{ item.id }}">
                              <div class="hidden pt-4" id="faq{{ item.id }}" role="tabpanel{{ item.id }}"
                              ...
                              <div class="hidden pt-4" id="about{{ item.id }}" role="tabpanel{{ item.id }}"
                          ...
                          <div
                            ...
                            <button data-modal-hide="staticModal{{item.id}}" type="button"
                              class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save</button>
                            <button data-modal-hide="staticModal{{item.id}}" type="button"
                              class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Cansel</button>
                          </div>
                        </div>
                      </div>
                    </div>
      ...
      <div class="flex items-center justify-between w-1/3 pt-3 mt-10 sm:pt-6">
        <div class="flex space-x-4">
          ...
          <svg @click="" class="text-gray-500 cursor-pointer" fill="none" stroke="currentColor" stroke-width="1.5"
