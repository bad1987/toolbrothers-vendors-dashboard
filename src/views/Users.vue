...
const fetchUsers = () => {
  ...
  userApi.fetchUsers(users, permissions, router, route, true, platforms).finally(() => {
        ...
        <div class="inline-block min-w-full align-middle">
          <div class="overflow-hidden shadow">
            ...
            >
              <div
                v-if="isLoading"
                class="absolute top-0 left-0 w-full h-full bg-white opacity-50 z-10 flex"
              >
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span v-if="u.roles == 'Role_direct_sale'">
                      {{ $t("mb_direct_sale") }}</span
                    >
                  </td>
                  <td
            ...
            <form action="#" id="add-admin-form">
              <div class="grid grid-cols-6 gap-6">
                ...
                >
                  ...
                  >
                    <option value="">{{ $t("mb_select_role") }}</option>
                    <option
                ...
                <div class="col-span-6">
                  <h4 class="font-bold dark:text-white">{{ $t("mb_set_permission") }}</h4>
                ...
                <div
                  class="col-span-6"
                  v-if="route.params.type == 'vendors' && platforms.length > 0"
                >
                  <label
                    for="role"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                    >{{ $t("mb_select_a_platform") }}</label
                  >
                  <select
                    data-te-select-init
                    @change="changeSelectedPlatform($event.target.value)"
                    id="platform"
              ...
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <select
                    ...
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  >
                    <option value="" selected>{{ $t("mb_select_role") }}</option>
                    <option value="Role_affiliate">{{ $t("mb_affiliate") }}</option>
                    <option value="Role_direct_sale">{{ $t("mb_direct_sale") }}</option>
                  </select>
                </div>
                <div class="mt-9 flex">
                  <input
            ...
            <form action="#" id="add-admin-form">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="flex items-center mb-4">
                  <input
                    v-model="newUser.status"
                    id="checkbox-activate-create-admin"
                    type="checkbox"
                    value=""
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                  />
                  <label
                    for="checkbox-activate-create-admin"
                    class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300"
                    >{{ $t("mb_active") }}</label
                  >
                </div>
