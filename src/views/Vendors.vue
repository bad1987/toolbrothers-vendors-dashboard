...
function addUser() {
  ...
  userApi
    .addUser(newUser, selectedPermissions, route, false)
    .then((response) => {
      fetchUsers();
...
const fetchUsers = () => {
  loadStore.changeLoadingStatus(true);
  userApi.fetchUsers(users, permissions, router, route, false).finally(() => {
...
function updateUser(obj = null) {
  loadStore.changeLoadingStatus(true);
  userApi
    .updateUser(obj, users, selectedUser, selectedPermissions, false)
    .then(() => {
          ...
          <div class="p-6 space-y-6">
            <form action="#" id="add-user-form" autocomplete="off">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                  <label for="password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Set a
                    password</label>
                ...
                <div class="mt-9 flex">
                  <input @change="changeSelectedStatus" v-model="newUser.status" id="checkbox-activate-create-vendor"
                    type="checkbox" value=""
